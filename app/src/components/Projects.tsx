...
function ProjectTab(props: IProjectTabs){   
    return (
        <div class="h-full w-full border-2 border-palette-pink mb-2">
            ...
            <main class="pl-2 pt-2 pr-2 text-[1.5vh] w-full h-[65%]">
                {props.content}
            </main>
            ...
            <section class="w-full h-[10%] flex justify-end items-center p-2">
                {props.deployed}
                <a class="border-2 text-[1.5vh] border-l-gray-50 border-t-gray-50 border-b-palette-purple border-r-palette-purple p-2 hover:cursor-cute-pointer m-2" href={props.repo} target="_blank">Github Repo</a>
            </section>
        </div>
        )
}
