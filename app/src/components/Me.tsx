    ...
    return (<div class="grid grid-rows-10 grid-cols-10 h-full w-full p-2">
        ...
        <section class="col-span-8 row-span-8 flex flex-col pl-2 pt-2 h-full">
            <Show when={props.mode == "About Me"}>
                <Post title="Introduction" content={<span class="h-full">Hello all! I'm Kevin, a 3rd Year at Cal Poly studying <a href="https://www.calpoly.edu/major/software-engineering" class="hover:cursor-pointer text-palette-purple" target="_blank"><u>Software Engineering</u></a> and minoring in the <a href="https://eadvise.calpoly.edu/Minors/Computing-for-Interactive-Arts" class=" text-palette-purple" target="_blank"><u>Computing for the Interactive Arts</u></a> program. <br/> <br/>Interests include Web or VR Development. Besides any sort of programming, I love to dabble in 3D modeling using Blender and Video Editing using Davinci Resolve. I will also nerd out about history given the chance :D</span>}/>
